...
export function MobileHeader({ onMenuToggle }: MobileHeaderProps = {}) {
  ...
  return (
    <header className="rounded-b-card border-b border-white/10 bg-[radial-gradient(80%_60%_at_50%_0%,var(--forest-700)_0%,rgba(15,80,61,0)_70%),linear-gradient(180deg,var(--forest-900)_0%,var(--forest-950)_100%)] px-4 pb-4 pt-[calc(env(safe-area-inset-top,0px)+1rem)] text-white sm:p-5">
