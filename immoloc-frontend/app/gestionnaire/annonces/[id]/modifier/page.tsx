  ...
  return (
    <div className="min-h-screen bg-background-alt flex items-center justify-center p-6">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <div>
          <h3 className="font-display text-lg font-bold text-foreground">Chargement de l’annonce gérée…</h3>
      ...
      <div className="card p-8 max-w-md w-full text-center space-y-5 shadow-xl">
        ...
        <div>
          ...
          <p className="text-xs text-foreground-muted mt-1.5 leading-relaxed">
            Vérifiez l&apos;identifiant du logement ou vos droits de gestion conciergerie.
          </p>
        </div>
...
export default function GestionnaireModifierAnnoncePage({
  params,
}: {
  ...
  const { data, isLoading, isError, refetch } = useQuery<ListingDetail>({
    queryKey: ['listing-gestionnaire', id],
    queryFn: () =>
