    ...
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">
          Paramètres Conciergerie
        </h1>
        <p className="text-sm text-foreground-muted mt-1">
          Configuration de votre agence, préférences de notification et paramètres du portail.
        </p>
      </div>
      ...
      <div className="rounded-card border border-dashed border-border bg-background-card p-12 text-center shadow-xs">
        ...
        <h2 className="text-base sm:text-lg font-semibold text-foreground">Paramètres de conciergerie</h2>
        <p className="text-xs sm:text-sm text-foreground-muted mt-1 max-w-md mx-auto leading-relaxed">
          La configuration des taux de commission, modèle de contrat et informations de l’agence sera disponible ici.
        </p>
      </div>
    </div>
  );
