      ...
      <section className="-mt-20 bg-[radial-gradient(70%_60%_at_50%_0%,var(--forest-700)_0%,rgba(15,80,61,0)_70%),linear-gradient(180deg,var(--forest-900)_0%,var(--forest-950)_100%)] pb-16 pt-32 text-white sm:pt-36">
        <div className="mx-auto max-w-[1120px] px-6 text-center">
          ...
          <h1 className="mx-auto mt-6 max-w-3xl font-display text-[clamp(2rem,5vw,3.25rem)] font-semibold leading-[1.06] tracking-[-0.03em] text-neutral-50">
            Comment votre argent est protégé<span className="text-on-inverse-marker">.</span>
          </h1>
              ...
              <li
                ...
                className={cn(
                  ...
                  isKey
                    ...
                    ? 'bg-[linear-gradient(180deg,var(--forest-900)_0%,var(--forest-950)_100%)] text-white'
              ...
              >
                <div className="mb-4 flex items-center justify-between gap-3">
                  <span className={cn(
                    ...
                    isKey ? 'bg-marker-bg text-on-inverse-marker' : 'bg-neutral-100 text-forest-700',
                  )}>
                ...
                <p className={cn(
                  ...
                  isKey ? 'text-on-inverse-marker' : 'text-forest-700',
                )}>
                  {money}
                </p>
