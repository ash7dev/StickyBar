  ...
  return (
    <div className="bg-surface-dark min-h-screen">
      ...
      <section className="relative pt-32 pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-900/25 via-surface-dark to-surface-dark" />
        <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-emerald-500/6 blur-[140px] rounded-full pointer-events-none" />
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center z-10">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black/50 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] mb-8">
            ...
            <span className="text-[10px] font-black text-emerald-200 uppercase tracking-[0.22em]">Nous contacter</span>
          </div>

          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black text-white tracking-tighter leading-[1.02] mb-8">
            On est là<br />
            <span className="text-emerald-400">pour vous</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[180px]">
            ...
            <a href={`mailto:contact@${BRAND.domain}`}
              ...
              <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-emerald-400/8 rounded-full blur-[60px] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="relative z-10 flex flex-col justify-between h-full">
      ...
      <section className="bg-white py-4 pb-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="relative bg-surface-dark overflow-hidden rounded-[3rem]">
            <div className="absolute top-0 right-1/4 w-[500px] h-[350px] bg-emerald-500/6 rounded-full blur-[120px] pointer-events-none" />
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      {[
                        ...
                        <div key={f.name}>
                          ...
                          <input
                            ...
                            className="w-full bg-black/50 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] rounded-xl px-4 py-3 text-sm font-medium text-white placeholder:text-white/20 focus:outline-none focus:border-emerald-500/50 focus:bg-black/70 transition-all"
                          />
                        </div>
                      ))}
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-black/50 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] rounded-xl px-4 py-3 text-sm font-medium text-white placeholder:text-white/20 focus:outline-none focus:border-emerald-500/50 focus:bg-black/70 transition-all resize-none leading-relaxed"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2.5 px-8 py-4 bg-emerald-500 text-white text-sm font-black rounded-full hover:bg-emerald-400 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 shadow-[0_0_30px_rgba(77,150,255,0.25)] hover:shadow-[0_0_50px_rgba(77,150,255,0.4)] hover:scale-[1.02] active:scale-[0.98]"
                    >
                      {sendState === 'sending' ? (
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      { channel: 'Téléphone', time: '< 5 minutes', dot: 'bg-emerald-400', text: 'text-emerald-400' },
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      >
                        <div className="w-7 h-7 rounded-lg bg-white/[0.04] flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-500/10 transition-colors">
                          <Icon className="w-3.5 h-3.5 text-white/25 group-hover:text-emerald-400 transition-colors" />
                        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              { icon: Clock, label: 'Horaires', value: 'Lun–Sam · 8h–20h', sub: 'Dimanche : urgences uniquement', accent: { bg: 'bg-emerald-50', border: 'border-emerald-100', text: 'text-emerald-500', glow: 'bg-emerald-400/8' } },
          ...
          <div className="mt-4 relative bg-surface-dark rounded-[2rem] overflow-hidden h-72 flex items-center justify-center border border-white/5">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-48 bg-emerald-500/5 rounded-full blur-[80px] pointer-events-none" />
            <div className="relative z-10 flex flex-col items-center gap-4 text-center">
              <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-400/20 flex items-center justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-emerald-500 text-white text-xs font-black hover:bg-emerald-400 transition-all shadow-[0_0_20px_rgba(77,150,255,0.2)] hover:shadow-[0_0_30px_rgba(77,150,255,0.35)] hover:scale-[1.02]"
              >
