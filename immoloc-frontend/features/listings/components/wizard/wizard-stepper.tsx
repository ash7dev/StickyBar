          ...
          <div key={step.id} className="flex items-center flex-1 min-w-0">
            <div className="flex flex-col items-center gap-1.5 flex-shrink-0">
              <button
                ...
                className={cn(
                  ...
                  canClick && !isActive && 'hover:bg-emerald-50 hover:text-emerald-600 hover:scale-105',
              ...
              >
                ...
                {isActive && (
                  <div className="absolute inset-0 bg-gradient-to-tr from-emerald-600 to-emerald-400 -z-10" />
                )}
              </button>
            ...
            {index < WIZARD_STEPS.length - 1 && (
              <div className="flex-1 h-[2px] mx-1 mb-4 sm:mb-5 bg-neutral-200/50 relative overflow-hidden rounded-full">
                <div
                  className="absolute inset-0 bg-emerald-400 transition-transform duration-700 ease-in-out origin-left"
