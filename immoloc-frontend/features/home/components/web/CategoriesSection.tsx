    ...
    <section className="bg-background pt-8 pb-24 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Link
            href="/logements"
            className="group relative bg-primary-900 p-10 sm:p-12 overflow-hidden transition-all duration-500 hover:scale-[1.01] rounded-[2rem] block"
          >
            <div className="absolute -top-20 -left-20 w-80 h-80 bg-primary-500/10 rounded-full blur-[80px] pointer-events-none group-hover:bg-primary-500/18 transition-colors duration-700" />
            <div
            ...
            />
            <span className="absolute -bottom-8 -right-4 text-[160px] font-black text-primary-400/4 leading-none select-none">01</span>
            ...
            <div className="relative z-10">
              ...
              <div className="w-14 h-14 bg-primary-500/10 rounded-2xl flex items-center justify-center mb-7 border border-primary-400/20 group-hover:bg-primary-500/20 transition-colors">
              ...
              <span className="flex items-center gap-2.5 text-primary-400 font-bold text-sm group-hover:gap-4 transition-all duration-300">
                Explorer les annonces <ArrowRight className="w-4 h-4" />
              </span>
            </div>

            <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-primary-500 group-hover:w-full transition-all duration-700 shadow-[0_0_12px_rgba(20,101,76,0.8)] rounded-b-[2rem]" />
          </Link>
