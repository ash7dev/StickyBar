...
export function HeroSection() {
  ...
  return (
    <section className="relative bg-primary-900 pt-32 pb-44 overflow-hidden min-h-[90vh] flex items-center rounded-b-[3rem]">
      {/* Ambient Glow Vert Forêt */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary-700/25 via-primary-900 to-primary-900" />
      <div className="absolute top-0 right-0 w-[55%] h-[55%] bg-primary-500/6 blur-[140px] rounded-full" />
      <div className="absolute bottom-0 left-0 w-[30%] h-[30%] bg-primary-800/10 blur-[80px] rounded-full" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-2xl z-10">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black/50 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] mb-8">
              ...
              <span className="text-[10px] font-black text-primary-100 uppercase tracking-[0.22em]">Sénégal • Premium</span>
            </div>

            <h1 className="text-6xl lg:text-8xl font-black text-white leading-[1.02] mb-8 tracking-tighter">
              L&apos;immobilier <br />
              <span className="text-primary-400">réinventé.</span>
            </h1>
          ...
          <div className="relative z-10 w-full h-[600px] hidden lg:block">
            ...
            <div className="absolute -inset-8 bg-primary-500/12 rounded-[4rem] blur-3xl" />
            ...
            <div className="relative w-full h-full rounded-[3rem] overflow-hidden border border-white/8 shadow-[0_0_60px_rgba(0,0,0,0.6)] group">
              ...
              {heroPhoto ? (
                ...
                <>
                  ...
                  <div className="absolute top-12 right-12 w-14 h-14 rounded-2xl bg-primary-500/20 border border-primary-400/20 flex items-center justify-center backdrop-blur-sm">
              ...
              <div className="absolute top-6 left-6 flex items-center gap-2 px-4 py-2 rounded-full bg-primary-600/90 backdrop-blur-sm text-white text-[10px] font-black uppercase tracking-widest shadow-lg">
              ...
              {featured ? (
                    ...
                    <div className="flex items-end justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          ...
                          <p className="text-primary-400 text-sm font-bold tracking-wide truncate">
                ...
                <div className="absolute bottom-7 left-7 bg-black/70 backdrop-blur-xl border border-white/15 p-5 rounded-2xl shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
                  <div className="flex items-center gap-3.5">
                    <div className="w-11 h-11 bg-primary-600 rounded-xl flex items-center justify-center text-white font-black text-sm">
                      <Home className="w-5 h-5" />
                    </div>
                    <div>
                      <p className="text-white font-bold text-sm">Chargement...</p>
                      <p className="text-primary-400 text-xs font-bold tracking-wide">ImmoLoc</p>
                    </div>
                  </div>
                </div>
              )}
