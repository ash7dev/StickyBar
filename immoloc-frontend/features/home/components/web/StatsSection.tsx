        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          {STATS.map((stat, i) => (
            <div key={i} className="text-center md:text-left group">
              <div className="text-5xl md:text-6xl font-black text-foreground mb-3 tracking-tighter group-hover:text-primary-600 transition-colors duration-300">
                {stat.value}
              </div>
              ...
              <div className="w-8 h-1 bg-primary-600 mt-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 hidden md:block" />
            </div>
          ))}
        </div>
      </div>
